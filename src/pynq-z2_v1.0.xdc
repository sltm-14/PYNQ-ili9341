...
set_property -dict { PACKAGE_PIN H16   IOSTANDARD LVCMOS33 } [get_ports { in_Clk }]; #IO_L13P_T2_MRCC_35 Sch=sysclk
...
set_property -dict { PACKAGE_PIN L15   IOSTANDARD LVCMOS33 } [get_ports { out_led_ini }]; #IO_L22N_T3_AD7N_35 Sch=led4_b
#set_property -dict { PACKAGE_PIN G17   IOSTANDARD LVCMOS33 } [get_ports { led4_g }]; #IO_L16P_T2_35 Sch=led4_g
#set_property -dict { PACKAGE_PIN N15   IOSTANDARD LVCMOS33 } [get_ports { led4_g }]; #IO_L21P_T3_DQS_AD14P_35 Sch=led4_r
...
set_property -dict { PACKAGE_PIN R14   IOSTANDARD LVCMOS33 } [get_ports { out_Motor_PWM_D[0] }]; #IO_L6N_T0_VREF_34 Sch=led[0]
set_property -dict { PACKAGE_PIN P14   IOSTANDARD LVCMOS33 } [get_ports { out_Motor_PWM_D[1] }]; #IO_L6P_T0_34 Sch=led[1]
set_property -dict { PACKAGE_PIN N16   IOSTANDARD LVCMOS33 } [get_ports { out_Motor_PWM_D[2] }]; #IO_L21N_T3_DQS_AD14N_35 Sch=led[2]
set_property -dict { PACKAGE_PIN M14   IOSTANDARD LVCMOS33 } [get_ports { out_Motor_PWM_D[3] }]; #IO_L23P_T3_35 Sch=led[3]

##Buttons

set_property -dict { PACKAGE_PIN D19   IOSTANDARD LVCMOS33 } [get_ports { in_Rst }]; #IO_L4P_T0_35 Sch=btn[0]
#set_property -dict { PACKAGE_PIN D20   IOSTANDARD LVCMOS33 } [get_ports { in_Enable }]; #IO_L4N_T0_35 Sch=btn[1]
...
#set_property -dict { PACKAGE_PIN Y18   IOSTANDARD LVCMOS33 } [get_ports { out_Motor_PWM_C[0] }]; #IO_L17P_T2_34 Sch=ja_p[1]
#set_property -dict { PACKAGE_PIN Y19   IOSTANDARD LVCMOS33 } [get_ports { out_Motor_PWM_C[1] }]; #IO_L17N_T2_34 Sch=ja_n[1]
#set_property -dict { PACKAGE_PIN Y16   IOSTANDARD LVCMOS33 } [get_ports { out_Motor_PWM_C[2] }]; #IO_L7P_T1_34 Sch=ja_p[2]
#set_property -dict { PACKAGE_PIN Y17   IOSTANDARD LVCMOS33 } [get_ports { out_Motor_PWM_C[3] }]; #IO_L7N_T1_34 Sch=ja_n[2]
set_property -dict { PACKAGE_PIN U18   IOSTANDARD LVCMOS33 } [get_ports { out_Motor_PWM_C[0] }]; #IO_L12P_T1_MRCC_34 Sch=ja_p[3]
set_property -dict { PACKAGE_PIN U19   IOSTANDARD LVCMOS33 } [get_ports { out_Motor_PWM_C[1] }]; #IO_L12N_T1_MRCC_34 Sch=ja_n[3]
set_property -dict { PACKAGE_PIN W18   IOSTANDARD LVCMOS33 } [get_ports { out_Motor_PWM_C[2] }]; #IO_L22P_T3_34 Sch=ja_p[4]
set_property -dict { PACKAGE_PIN W19   IOSTANDARD LVCMOS33 } [get_ports { out_Motor_PWM_C[3] }]; #IO_L22N_T3_34 Sch=ja_n[4]
...
set_property -dict { PACKAGE_PIN W16   IOSTANDARD LVCMOS33 } [get_ports { out_Tx }]; #IO_L18N_T2_34 Sch=jb_n[3]
set_property -dict { PACKAGE_PIN V12   IOSTANDARD LVCMOS33 } [get_ports { in_Rx }]; #IO_L4P_T0_34 Sch=jb_p[4]
...
#set_property -dict { PACKAGE_PIN v7    IOSTANDARD LVCMOS33 } [get_ports { out_Degrees[0] }]; ###??????
#set_property -dict { PACKAGE_PIN U8    IOSTANDARD LVCMOS33 } [get_ports { out_Motor_PWM_A[0] }]; #IO_L17N_T2_13 Sch=rpio_22_r
# ==== 3.3 V ===================================================================================================================
#set_property -dict { PACKAGE_PIN V8    IOSTANDARD LVCMOS33 } [get_ports { out_Motor_PWM_A[1] }]; #IO_L15P_T2_DQS_13 Sch=rpio_10_r
#set_property -dict { PACKAGE_PIN V10   IOSTANDARD LVCMOS33 } [get_ports { out_Motor_PWM_A[2] }]; #IO_L21N_T3_DQS_13 Sch=rpio_09_r
#set_property -dict { PACKAGE_PIN W10   IOSTANDARD LVCMOS33 } [get_ports { out_Motor_PWM_A[3] }]; #IO_L16P_T2_13 Sch=rpio_11_r
# --- GND ----------------------------------------------------------------------------------------------------------------------
#set_property -dict { PACKAGE_PIN Y16   IOSTANDARD LVCMOS33 } [get_ports { out_Motor_PWM_B[0] }]; #IO_L7P_T1_34 Sch=rpio_sd_r
...
#set_property -dict { PACKAGE_PIN W8    IOSTANDARD LVCMOS33 } [get_ports { out_Motor_PWM_B[0] }]; #IO_L15N_T2_DQS_13 Sch=rpio_13_r
#set_property -dict { PACKAGE_PIN Y8    IOSTANDARD LVCMOS33 } [get_ports { out_Motor_PWM_B[1] }]; #IO_L14N_T2_SRCC_13 Sch=rpio_19_r
#set_property -dict { PACKAGE_PIN W9    IOSTANDARD LVCMOS33 } [get_ports { out_Motor_PWM_B[2] }]; #IO_L16N_T2_13 Sch=rpio_26_r
# --- GND ----------------------------------------------------------------------------------------------------------------------
################################################################################################################################
# ==== 5 V =====================================================================================================================
# ==== 5 V =====================================================================================================================
# --- GND ----------------------------------------------------------------------------------------------------------------------
#set_property -dict { PACKAGE_PIN Y9    IOSTANDARD LVCMOS33 } [get_ports { out_Motor_PWM_B[3] }]; #IO_L14P_T2_SRCC_13 Sch=rpio_21_r
