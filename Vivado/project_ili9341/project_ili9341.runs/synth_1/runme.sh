...
HD_PWD='C:/Carem/ILI9341/ILI9341/Pynq-ili9341/Vivado/project_ili9341/project_ili9341.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_spi_master.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_spi_master.tcl
